...
public class StreamExample {
    ...
    public static void example2() {
        ...
        try {
            ...
            List<String> results = fileLines.filter(line -> line.length() > 120).collect(Collectors.toList());
            ...
            fileLines = Files.lines(Paths.get("movieReviews.txt"));
            results = fileLines.filter(line -> line.length() < 40)
                    .filter(line-> line.startsWith("1")).collect(Collectors.toList());
            for (String line: results) {
                System.out.println(line);
            }
             ...
             */
            fileLines = Files.lines(Paths.get("movieReviews.txt"));
            results = fileLines.map(line-> line.toLowerCase()).collect(Collectors.toList());
            for (String line: results) {
                System.out.println(line);
            }
    ...
    public static void example3() {
        ...
        try {
            ...
            */
            List<String> words = fileLines.flatMap(line -> Arrays.stream(line.split(" ")))
                    .collect(Collectors.toList());
    ...
    public static void example4() {
         ...
         */
        List<Double> sortedList = data.stream().sorted((x,y) -> (x.compareTo(y))).collect(Collectors.toList());
